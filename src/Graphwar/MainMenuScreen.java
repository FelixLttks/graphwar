...
public class MainMenuScreen extends JPanel implements ActionListener {
	...
	public MainMenuScreen(Graphwar graphwar, String confFile) throws InterruptedException, IOException {
		...
		// Stack used to add components in reverse order, because swing draws components
		// added first first
	...
	public void actionPerformed(ActionEvent arg0) {
		if (this.joinGlobalVisible) {
			...
			if (arg0.getSource() == this.noButtonCreate) {
				...
				this.showMessage = false;
				this.repaint();
			} else if (arg0.getSource() == this.yesButtonCreate || arg0.getSource() == nameFieldCreate
					|| arg0.getSource() == portFieldCreate) {
				try {
			...
			if (arg0.getSource() == this.noButtonJoin) {
				...
				this.showMessage = false;
				this.repaint();
			} else if (arg0.getSource() == yesButtonJoin || arg0.getSource() == nameFieldJoin
					|| arg0.getSource() == ipFieldJoin || arg0.getSource() == portFieldJoin) {
				try {
